...
<head>
   ...
   <title>Colin Noël - Mentions légales</title>
   ...
   <div id="smooth-wrapper">
      <div id="smooth-content">
         <main>
            ...
            <div class="tp-pricing-area pre-header tp-pricing-2-spacing bg-position pb-140 pricing-bg">
           ...
           <div class="tp-team-details-area pre-header pt-160 pb-100">
         ...
         <div class="col-lg-12">
            <div class="tp-team-details-title-wrap ml-35">
               ...
               <p class="tp-section-ai-para tp-ff-p mb-35 fw-400 fs-20 ls-m-2 lh-150-per tp-text-common-black-6">
                  ...
                  <strong>Adresse postale :</strong> Donville-les-Bains<br>
                  <!-- <strong>Numéro de SIRET :</strong> [Ton numéro SIRET si tu en as un, sinon "En cours d'immatriculation"] -->
               </p>
            </div>
         </div>
      </div>
