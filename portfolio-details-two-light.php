...
<head>
   ...
   <title>PORTFOLIO - Projets Identité Visuelle : LE BAR ET VOUS
</title>
   ...
   <div id="smooth-wrapper">
      <div id="smooth-content">
         <main>
            ...
            <div class="tp-breadcrumb-4-area pre-header tp-breadcrumb-4-spacing bg-position" data-background="assets/img/breadcrumb/thumb-14.jpg">
            ...
            <div class="tp-portfolio-details-2-area pt-155 pb-155">
               <div class="tp-portfolio-details-2-content pb-120">
                        ...
                        <div class="col-lg-4">
                           <div class="tp-portfolio-details-2-cetagory-wrap mb-30">
                              ...
                              <div class="tp-portfolio-details-2-cetagory">
                                 <ul>
                                    <li>
                                       <span class="spacing">Catégorie :</span>
                                       <span>Communication Globale</span>
                                    </li>
                                    <li>
                                       <span class="spacing">Client Name :</span>
                                       <span>Mr. Khaled Selmi</span>
                                    </li>
                                    <li>
                                       <span class="spacing">Activité</span>
                                       <span>Bar & Comedy Club</span>
                                    </li>
                                    <li>
                                       <span class="spacing">Lieu</span>
                                       <span> Saint-Denis-le-Gast, France</span>
                                    </li>
                                    <li>
                                       <span class="spacing">Date du lancement</span>
                                       <span>02 Février, 2024 - 02 Août, 2025</span>
                                    </li>
                                 </ul>
                              </div>
                           </div>
               ...
               <div class="tp-portfolio-details-2-thumb-wrap pb-120">
                  <div class="container-fluid container-1524">
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="tp-portfolio-details-2-thumb tp-round-20 fix mb-30">
                              <img data-speed=".8" class="w-100" src="assets/img/portfolio/details/two/thumb.jpg" alt="">
                           </div>
                        </div>
                        <div class="col-lg-8">
                           <div class="tp-portfolio-details-2-thumb tp-round-20 fix mb-30 ml-70">
                              <img data-speed=".8" class="w-100" src="assets/img/portfolio/details/two/thumb-2.jpg" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="tp-portfolio-details-2-content pb-40">
                  <div class="container-fluid container-1524">
                     <div class="row">
                        <div class="col-lg-12">
                           ...
                           <div class="tp-service-details-content tp-portfolio-details-2-branding mb-30">
                              ...
                              <ul>
                                 <li>
                                    ...
                                    <p><b>Analyse de l'espace -</b> Étude de la configuration réelle du bar pour que les supports physiques s'intègrent naturellement à l'architecture et à la lumière du lieu.</p>
                                 </li>
                                 <li>
                                    <i class="fa-regular fa-circle-check"></i>
                                    <p><b>Hiérarchie de lecture –</b> Travail sur la clarté des informations essentielles (artistes, horaires, réservations) pour optimiser le taux de conversion des annonces.</p>
                                 </li>
                                 <li>
                                    <i class="fa-regular fa-circle-check"></i>
                                    <p><b>Logistique technique –</b> Accompagnement sur le choix des supports d'impression et des formats numériques pour garantir une qualité constante sur chaque point de contact.</p>
                                 </li>
                                 <li>
                                    <i class="fa-regular fa-circle-check"></i>
                                    <p><b>Veille créative –</b> Adaptation des codes du divertissement actuel pour proposer une communication qui reste moderne et pertinente au fil des saisons.</p>
                                 </li>
                              </ul>
                           </div>
                        </div>
               ...
               <div class="tp-portfolio-details-2-thumb-wrap pb-130">
                  <div class="container-fluid container-1524">
                     <div class="row">
                        <div class="col-lg-8">
                           <div class="tp-portfolio-details-2-thumb tp-round-20 fix mb-30 mr-70">
                              <img data-speed=".8" class="w-100" src="assets/img/portfolio/details/two/thumb-3.jpg" alt="">
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="tp-portfolio-details-2-thumb tp-round-20 fix mb-30">
                              <img data-speed=".8" class="w-100" src="assets/img/portfolio/details/two/thumb-4.jpg" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           <div class="col-lg-6 col-md-7">
                              <div class="tp-portfolio-details-2-tag mb-20">
                                 <a href="#">Accompagnement Créatif</a>
                                 <a href="#">Direction Artistique</a>
                                 <a href="#">Gestion Événementielle</a>
                              </div>
                           </div>
            ...
            <!-- <div class="tp-about-me-banner scale-up-img">
               <img class="img-cover scale-up" data-speed="0.4" src="assets/img/portfolio/details/two/banner.jpg" alt="About Thumbnail">
            </div> -->
            <!-- tp-banner-area-end -->

            <!-- tp-portfolio-area-start -->
            <!-- <div class="tp-portfolio-area pb-110 pt-155">
               <div class="container">
                  <div class="row">
                     <div class="col-12">
                        <div class="tp-portfolio-cst-subtitle-wrap tp-portfolio-details-2-subtitle d-flex justify-content-between flex-wrap align-items-center mb-20">
                           <h5 class="mb-15 tp-ff-dm fw-600 tp-text-common-black fs-32 ls-m-2">Related Project</h5>
                           <a href="blog-grid-2-light.html" class="mb-15 d-inline-block lh-0 fs-16 ls-0 tp-btn-switch-2-animation tp-text-common-black hover-text-black fw-700 tp-ff-dm">
                              <span class="d-flex align-items-center justify-content-center">
                                 <span class="btn-text">All Articles</span>
                                 <span class="btn-icon">
                     ...
                     <div class="col-lg-6">
                        <div class="tp-portfolio-sa-item mb-50 not-hide-cursor" data-cursor="View<br>Demo">
                           <div class="tp-portfolio-sa-thumb mb-25">
                              <a href="portfolio-details-two-light.html" class="cursor-hide">
                                 <img class="w-100 mover" src="assets/img/portfolio/sa/thumb.jpg" alt="">
                              </a>
                           </div>
                           <div class="tp-portfolio-sa-content">
                              <h4 class="tp-portfolio-sa-item-title tp-ff-dm fs-25 lh-1 mb-15"><a class="underline-black" href="portfolio-details-two-light.html">Crafting Digital Experiences</a></h4>
                              <span class="tp-portfolio-sa-item-tag fw-700 fs-16 tp-text-grey-1 tp-ff-dm tp-bg-common-white-2 d-inline-block">UI/UX Design</span>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="tp-portfolio-sa-item mb-50 not-hide-cursor" data-cursor="View<br>Demo">
                           <div class="tp-portfolio-sa-thumb mb-25">
                              <a href="portfolio-details-two-light.html" class="cursor-hide">
                                 <img class="w-100" src="assets/img/portfolio/sa/thumb-2.jpg" alt="">
                              </a>
                           </div>
                           <div class="tp-portfolio-sa-content">
                              <h4 class="tp-portfolio-sa-item-title tp-ff-dm fs-25 lh-1 mb-15"><a class="underline-black" href="portfolio-details-two-light.html">Building Visual Identities</a></h4>
                              <span class="tp-portfolio-sa-item-tag fw-700 fs-16 tp-text-grey-1 tp-ff-dm tp-bg-common-white-2 d-inline-block">Web Design</span>
                           </div>
                        </div>
                     </div>
                  </div>
