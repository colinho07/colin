...
<!-- End Google Tag Manager -->
   ...
   <title>CONTACT - Colin Noël</title>
   ...
   <div class="tp-offcanvas-area">
      <div class="tp-offcanvas">
         ...
         <div class="tp-offcanvas-content d-none d-xl-block">
            <h3 class="tp-offcanvas-title">À vous de jouer !</h3>
            <p> Votre projet mérite d'être sous les projecteurs. Remplissez le formulaire et commençons le spectacle. </p>
         </div>
   ...
   <div id="smooth-wrapper">
      <div id="smooth-content">
         <main>
            ...
            <div class="tp-contact-area pre-header tp-contact-spacing pb-140">
               <div class="container containers">
                  <div class="row justify-content-center">
                     <div class="col-lg-8">
                        <div class="tp-contact-wrap">
                           <div class="text-center mb-60">
                              <h2 class="tp-section-title fs-70 fs-xl-60 fs-lg-50 fs-xs-40 mb-10">Entrons en contact</h2>
                              <p class="fs-18 lh-150-per">Si vous avez un projet en tête, si vous cherchez simplement à échanger ou si vous avez une idée, n'hésitez pas à me contacter.</div>
                           <div class="tp-contact-number mb-70">
                              <div class="d-flex align-items-center mb-15 mr-20">
                                 <span class="tp-contact-icon mr-15">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <a class="tp-contact-email" href="mailto:noel_colin@icloud.com">noel_colin@icloud.com</a>
                              </div>
                              <!-- <div class="d-flex align-items-center mb-15">
                                 ...
                                 <a class="tp-contact-email" href="telto:">+92 764 435 5334</a>
                              </div> -->
                           </div>
                                ...
                                <input type="hidden" name="access_key" value="28b949cd-1538-437b-a8a2-594a05581739">
                                 <div class="row">
                                    <div class="col-xl-6">
                                       <div class="tp-postbox-details-input mb-25">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="name">Nom & Prénom</label>
                                          <input name="name" class="tp-input" type="text" id="name" placeholder="Dupont Eric">
                                       </div>
                                    </div>
                                    <div class="col-xl-6">
                                       <div class="tp-postbox-details-input mb-25">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="email">Email</label>
                                          <input name="email" class="tp-input" type="email" id="email" placeholder="dupont.eric@mail.com">
                                       </div>
                                    </div>
                                    <div class="col-xl-6">
                                       <div class="tp-postbox-details-input mb-25">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="company">Entreprise</label>
                                          <input name="company" class="tp-input" type="text" id="company" placeholder="Ex. Microsoft ">
                                       </div>
                                    </div>
                                    <div class="col-xl-6">
                                       <div class="tp-postbox-details-input mb-25">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="phone">Téléphone <span class="tp-text-grey-2">(Optionnel)</span></label>
                                          <input name="phone" class="tp-input" type="text" id="phone" placeholder="06 85 44 53 **">
                                       </div>
                                    </div>
                                    <div class="col-xl-12">
                                       <div class="tp-postbox-details-input mb-25">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="service">Choisissez le service</label>
                                          <select id="service" class="tp-select tp-input mb-20" name="service">
                                             <option value="1">Sites Web</option>
                                             <option value="2">Identité Visuelle</option>
                                             <option value="3">Montage Photo & Vidéo</option>
                                             <option value="4">Design 3D</option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="col-xl-12">
                                       <div class="tp-postbox-details-input mb-10">
                                          <label class="fs-18 tp-ff-p tp-text-common-black mb-10" for="msg">Détail du projet</label>
                                          <textarea name="message" class="tp-input tp-textarea" id="msg" placeholder="Écrire pour briefer sur le projet"></textarea>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="tp-postbox-details-remember mb-30">
                                    <input name="checkbox" class="tp-checkbox" id="remeber" type="checkbox">
                                    <label for="remeber">J'accepte de recevoir des informations en lien avec ma demande et vos services.</label>
                                 </div>
                                 <div class="tp-postbox-details-input-box">
                                    <button type="submit" class="tp-btn-sm tp-left-right fw-500 tp-ff-heading fs-15 text-uppercase tp-text-common-black tp-bg-theme-primary tp-round-36">
                                       <span class="mr10 td-text d-inline-block mr-5">Envoyer</span>
