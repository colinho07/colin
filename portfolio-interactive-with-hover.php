  ...
  <div class="tp-offcanvas-area">
      <div class="tp-offcanvas">
         ...
         <div class="tp-offcanvas-content d-none d-xl-block">
            <h3 class="tp-offcanvas-title">Sillonner mes travaux !</h3>
            <p> Je vous invite à découvrir ma patte graphique et la diversité des supports que je maîtrise, du web à la vidéo. </p>
         </div>
                                ...
                                <div class="tp-porfolio-10-title-wrap z-index-5">
                                    <ul>
                                        <li rel="tp-porfolio-10-bg-1">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">DELAMARCHE</h2>
                                                    <span class="tp-porfolio-10-category">/ Production Vidéo</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li rel="tp-porfolio-10-bg-2">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">Projet</h2>
                                        ...
                                        <li rel="tp-porfolio-10-bg-3">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">CULTIO</h2>
                                                    <span class="tp-porfolio-10-category">/ UX/UI</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="active" rel="tp-porfolio-10-bg-4">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">LE BAR ET VOUS</h2>
                                                    <span class="tp-porfolio-10-category">/ Redesign Complet</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li rel="tp-porfolio-10-bg-5">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">Projet MMI</h2>
                                                    <span class="tp-porfolio-10-category">/ Application</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li rel="tp-porfolio-10-bg-6">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    ...
                                                    <span class="tp-porfolio-10-category">/ Web Design</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li rel="tp-porfolio-10-bg-7">
                                            <a href="portfolio-details-gallery-light.html">
                                                <div class="tp-porfolio-10-title-box d-flex align-items-end">
                                                    <h2 class="tp-porfolio-10-title">Jeux vidéos</h2>
                                                    <span class="tp-porfolio-10-category">/ Développement de jeux</span>
                                                </div>
                                            </a>
                                        </li>
