                        ...
                        <div class="col-12">
                           <div class="tp-footer-copyright text-center">
                              <p class="mb-0 tp-text-grey-2">
                                 ...
                                 Copyright 2026 <a class="tp-text-common-white hover-text-primary" href="#">Colin Noël</a> Tous droits réservés. <br> <a href="mentions-legales.php">Mentions légales</a>
                              </p>
                           </div>
                        </div>
                     </div>
