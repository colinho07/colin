...
<head>
   ...
   <title>PORTFOLIO - Projets Design 3D : Projets d'Études</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="tp-pd-2-banner">
                                    <img data-speed=".8" src="assets/img/portfolio/gallery/portfolio-details-thumb-1.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="tp-pd-2-slider-wrapper">
                                    <div class="swiper tp-pd-2-active">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="tp-pd-2-slider-thumb">
                                                    <img src="assets/img/portfolio/gallery/portfolio-details-thumb-2.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tp-pd-2-slider-thumb">
                                                    <img src="assets/img/portfolio/gallery/portfolio-details-thumb-3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tp-pd-2-slider-thumb">
                                                    <img src="assets/img/portfolio/gallery/portfolio-details-thumb-4.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tp-pd-2-slider-thumb">
                        ...
                        <div class="row gx-20">
                            <div class="col-lg-12">
                                <div class="tp-pd-2-thumb-item mb-20">
                                    <img data-speed=".8" src="assets/img/portfolio/gallery/portfolio-details-thumb-5.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="tp-pd-2-thumb-item mb-20">
                                    <img data-speed=".8" src="assets/img/portfolio/gallery/portfolio-details-thumb-6.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="tp-pd-2-thumb-item mb-20">
                                    <img data-speed=".8" src="assets/img/portfolio/gallery/portfolio-details-thumb-7.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
