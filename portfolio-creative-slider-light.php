   ...
   <div class="tp-offcanvas-area">
      <div class="tp-offcanvas">
         ...
         <div class="tp-offcanvas-content d-none d-xl-block">
            <h3 class="tp-offcanvas-title">Tout pour briller !</h3>
            <p> De l'idée brute au déploiement final, explorez les leviers créatifs et techniques que j'active pour donner à votre projet l'audience qu'il mérite. </p>
         </div>
        ...
        <div class="tp-portfolio-creative-wrap fix p-relative">
            <div class="tp-portfolio-creative-slider-main">
                ...
                <div class="tp-portfolio-revealing-slider-social tp-portfolio-creative-social">
                    <a class="tp-hover-btn-item" href="https://www.linkedin.com/in/colin-noël/">In</a>
                    <a class="tp-hover-btn-item" href="https://dribbble.com/colin_noel">Dr</a>
                    <a class="tp-hover-btn-item" href="https://www.behance.net/colin_noel">Be</a>
                </div>
            </div>
        </div>
